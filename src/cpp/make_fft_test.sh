...
g++ -std=c++11 fft_test.cpp -I${BOOST_DIR} -I../../ -I${FFTW_DIR} -I../../src/include -DFPGA -DNDEBUG -O0 -g -DZNN_CUBE_POOL_LOCKFREE -DZNN_USE_FLOATS -lpthread -lrt -lfftw3f -o fft_test -DZNN_DONT_CACHE_FFTS -O2 -fPIC -I../common/inc \
