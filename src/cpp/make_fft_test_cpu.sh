...
g++ -std=c++11 fft_test.cpp -I${BOOST_DIR} -I../../ -I${FFTW_DIR} -I../../src/include -DNDEBUG -O3 -DZNN_MEASURE_FFT_RUNTIME -DZNN_CUBE_POOL_LOCKFREE -DZNN_USE_FLOATS -lpthread -lrt -lfftw3f -o fft_test_cpu -DZNN_DONT_CACHE_FFTS -O2 -fPIC -I../common/inc \
            -I${HLD_DIR}/host/include  -I${AOCL_SDK}/inc -L${BOARD_DIR}/linux64/lib -L${HLD_DIR}/host/linux64/lib -Wl,--no-as-needed -lalteracl ${BOARD_LIB} -lelf -lgomp
